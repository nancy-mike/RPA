...
operation:
  ...
  inputs:
    ...
    - password
  sequential_action:
    gav: 'com.microfocus.seq:web_action.reg_user:1.0.0'
    skills:
      - SAP
      - UI Automation
      - Web
    ...
    steps:
      ...
      - step:
          ...
          action: Set
          default_args: '"myemail@domain.com"'
          ...
          - object:
              ...
              child_objects:
                - object:
                    ...
                    class: WebElement
                    visual_relations: ''
                    last_update_time: 'Thursday, January 21, 2021 9:07:10 AM'
